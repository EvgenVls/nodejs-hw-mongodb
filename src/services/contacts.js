...
export const getContactById = (contact) => {
...
export const updateContact = async (contact, payload, options = {}) => {
...
export const deleteContact = (contact) => {
  const deletedContact = ContactsCollection.findOneAndDelete(contact);
